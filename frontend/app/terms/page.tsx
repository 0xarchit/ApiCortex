        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none space-y-10">
            <section>
              ...
              <div className="text-[#9AA3B2] space-y-3">
                <p>
                  ...
                  (&quot;Platform&quot;) at apicortex.ai, you agree to be bound
            ...
            <section>
              ...
              <div className="text-[#9AA3B2] space-y-3">
                <p>
                  ApiCortex provides API monitoring, anomaly detection, contract
                  validation, and telemetry analytics (&quot;Service&quot;). We
            ...
            <section>
              ...
              <div className="text-[#9AA3B2] space-y-3">
                <p>
                  ...
                  credentials. ApiCortex is not liable for any loss caused by
                  unauthorized access.
                </p>
                <p>
                  One account per person. Sharing account access with multiple
                  users requires a team plan.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-[#9AA3B2] space-y-3">
                ...
                <ul className="space-y-2 list-disc pl-5">
                  ...
                  <li>
                    Overload, damage, or impair the Platform beyond intended use
                  </li>
                  <li>
                    Reverse engineer or extract the Platform&apos;s proprietary
                    models
                  </li>
            ...
            <section>
              ...
              <div className="text-[#9AA3B2] space-y-3">
                <p>
                  ...
                  Platform (&quot;Content&quot;). By using the Platform, you
                  grant ApiCortex a non-exclusive, worldwide license to use your
                  Content solely for the purpose of providing the Service.
                </p>
                <p>
                  ApiCortex claims no ownership over your OpenAPI
                  specifications, API configurations, or telemetry data.
                </p>
              </div>
            </section>

            <section>
              <h2 className="text-xl font-bold mb-4">6. Fees &amp; Payment</h2>
              <div className="text-[#9AA3B2] space-y-3">
                <p>
                  Usage of paid plans is billed according to the pricing page.
                  All fees are non-refundable unless required by law. We reserve
            ...
            <section>
              ...
              <div className="text-[#9AA3B2] space-y-3">
                <p>
                  ...
                  ApiCortex does not guarantee that anomaly detection will catch
                  every failure.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-[#9AA3B2] space-y-3">
                <p>
                  TO THE MAXIMUM EXTENT PERMITTED BY LAW, ApiCortex SHALL NOT BE
            ...
            <section>
              ...
              <div className="text-[#9AA3B2] space-y-3">
                <p>
                  ...
                  termination, your data is retained for 30 days before
                  permanent deletion.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-[#9AA3B2] space-y-3">
                <p>
                  ApiCortex may update these Terms at any time. Material changes
                  will be communicated via email. Continued use of the Platform
            ...
            <section>
              ...
              <div className="text-[#9AA3B2] space-y-3">
                <p>
                  ...
                  are resolved in the courts of Delaware.
                </p>
              </div>
            </section>
